    ...
    private static readonly IReadOnlyDictionary<AppLanguage, IReadOnlyDictionary<TextKey, string>> Catalog =
        new Dictionary<AppLanguage, IReadOnlyDictionary<TextKey, string>>
        {
            [AppLanguage.Hungarian] = CreateTranslations(
                ...
                (TextKey.ButtonRestoreSelectedModules, "Kijelölt modul visszaállítása"),
                (TextKey.ButtonRefreshModules, "Modlista frissítése"),
                (TextKey.ButtonOpenModsFolder, "Mods mappa megnyitása"),
                (TextKey.ButtonLaunchGame, "Játék indítása"),
                (TextKey.CheckBoxDevMode, "Indítás -dev módban"),
                (TextKey.ModulesLabel, "Modulok:"),
                (TextKey.ModuleRobotLoot, "Robot Loot"),
                (TextKey.ModuleBeehiveAutomation, "Beehive Automation"),
                (TextKey.ModuleFreezerAutomation, "Freezer Automation"),
                (TextKey.ModuleSourceOnline, "Online"),
                (TextKey.ModuleSourceLocal, "Helyi"),
                (TextKey.ModuleLocalUnverified, "helyi, nem hitelesített"),
                (TextKey.ModuleStatusNotChecked, "Nincs ellenőrizve"),
                (TextKey.ModuleStatusNotInstalled, "Nincs telepítve"),
                (TextKey.ModuleStatusUnavailable, "Nem érhető el a latest kiadásban"),
                (TextKey.ModuleStatusUpToDate, "Naprakész ({0})"),
                (TextKey.ModuleStatusUpdateAvailable, "Frissítés elérhető ({0})"),
                (TextKey.ModuleStatusInstalled, "Telepítve ({0})"),
                (TextKey.ModuleStatusRestored, "Visszaállítva"),
                (TextKey.ModuleBackupAvailable, "Backup: elérhető ({0})"),
                (TextKey.ModuleBackupMissing, "Backup: nincs"),
                (TextKey.ModuleBackupCorrupt, "Backup: sérült snapshot"),
                (TextKey.ModuleBackupLegacy, "Backup: legacy snapshot (csak teljes visszaállítás)"),
                ...
                (TextKey.LogModulePayloadDownload, "Modulpayload letöltése: {0} — {1}"),
                (TextKey.LogSelectedModulesInstalled, "Kijelölt modulok telepítve/frissítve: {0}; {1} fájl."),
                (TextKey.LogModuleRestored, "Modul visszaállítva: {0}; backup: {1}"),
                (TextKey.LogHistoryReadWarning, "A műveleti előzmények olvasása sikertelen: {0}"),
                (TextKey.LogHistoryWriteWarning, "A műveleti előzmények mentése sikertelen: {0}"),
                (TextKey.LogUnknownPersistedEvent, "Korábbi esemény: {0}"),
                (TextKey.LogOnlineCatalogFallback, "Az online modcatalog nem érhető el; fallback lista használata: {0}"),
                (TextKey.LogModuleSourceIssue, "Modulforrás-hiba: {0} — {1}"),
                ...
                (TextKey.DialogRestoreSelectedModulesTitle, "Kijelölt modul visszaállítása"),
                (TextKey.DialogRestoreSelectedModulesMessage, "Visszaállítod a kijelölt modulokat?\n\n{0}"),
                ...
                (TextKey.ErrorNoModulesSelected, "Nincs kijelölt modul. Jelölj ki legalább egy modult."),
                (TextKey.ErrorSelectedModulesUnavailable, "A kijelölt modulok nem érhetők el vagy nem telepíthetők: {0}"),
                (TextKey.ErrorModuleCatalogUnavailable, "Nem érhető el valid online vagy helyi modulcsomag."),
                (TextKey.ErrorModuleTargetConflict, "A kijelölt modulok ugyanazt a célfájlt módosítják: {0}"),
                (TextKey.ErrorModulesNoCommonBuild, "A kijelölt moduloknak nincs közös támogatott Steam buildje."),
                (TextKey.ErrorNoSelectedModuleBackup, "A kijelölt modulhoz nincs visszaállítható modul-backup: {0}"),
            ...
            [AppLanguage.English] = CreateTranslations(
                ...
                (TextKey.ButtonRestoreSelectedModules, "Restore selected module"),
                (TextKey.ButtonRefreshModules, "Refresh module list"),
                (TextKey.ButtonOpenModsFolder, "Open Mods folder"),
                (TextKey.ButtonLaunchGame, "Launch game"),
                (TextKey.CheckBoxDevMode, "Launch in -dev mode"),
                (TextKey.ModulesLabel, "Modules:"),
                (TextKey.ModuleRobotLoot, "Robot Loot"),
                (TextKey.ModuleBeehiveAutomation, "Beehive Automation"),
                (TextKey.ModuleFreezerAutomation, "Freezer Automation"),
                (TextKey.ModuleSourceOnline, "Online"),
                (TextKey.ModuleSourceLocal, "Local"),
                (TextKey.ModuleLocalUnverified, "local, unverified"),
                (TextKey.ModuleStatusNotChecked, "Not checked"),
                (TextKey.ModuleStatusNotInstalled, "Not installed"),
                (TextKey.ModuleStatusUnavailable, "Not available in the latest release"),
                (TextKey.ModuleStatusUpToDate, "Up to date ({0})"),
                (TextKey.ModuleStatusUpdateAvailable, "Update available ({0})"),
                (TextKey.ModuleStatusInstalled, "Installed ({0})"),
                (TextKey.ModuleStatusRestored, "Restored"),
                (TextKey.ModuleBackupAvailable, "Backup available ({0})"),
                (TextKey.ModuleBackupMissing, "No backup available"),
                (TextKey.ModuleBackupCorrupt, "Backup snapshot is corrupt"),
                (TextKey.ModuleBackupLegacy, "Legacy backup available (full restore only)"),
                ...
                (TextKey.LogModulePayloadDownload, "Downloading module payload: {0} — {1}"),
                (TextKey.LogSelectedModulesInstalled, "Selected modules installed/updated: {0}; {1} file(s)."),
                (TextKey.LogModuleRestored, "Module restored: {0}; backup: {1}"),
                (TextKey.LogHistoryReadWarning, "Operation history could not be read: {0}"),
                (TextKey.LogHistoryWriteWarning, "Operation history could not be saved: {0}"),
                (TextKey.LogUnknownPersistedEvent, "{0}"),
                (TextKey.LogOnlineCatalogFallback, "The online module catalog is unavailable; using fallback list: {0}"),
                (TextKey.LogModuleSourceIssue, "Module source error: {0} — {1}"),
                ...
                (TextKey.DialogRestoreSelectedModulesTitle, "Restore selected module"),
                (TextKey.DialogRestoreSelectedModulesMessage, "Restore the selected modules?\n\n{0}"),
                ...
                (TextKey.ErrorNoModulesSelected, "No selected modules. Select at least one module."),
                (TextKey.ErrorSelectedModulesUnavailable, "The selected modules are unavailable or cannot be installed: {0}"),
                (TextKey.ErrorModuleCatalogUnavailable, "No valid online or local module package is available."),
                (TextKey.ErrorModuleTargetConflict, "The selected modules modify the same target file: {0}"),
                (TextKey.ErrorModulesNoCommonBuild, "The selected modules have no common supported Steam build."),
                (TextKey.ErrorNoSelectedModuleBackup, "No restorable module backup was found for the selected module: {0}"),
